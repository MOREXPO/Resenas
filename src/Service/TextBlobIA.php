...
class TextBlobIA implements InteligenciaArtificialInterface
{
    ...
    {
        $ia = $this->inteligenciaArtificialRepository->findOneBy(["nombre" => "textblobia"]);
        ...
        $process = new Process(['python3', '/var/www/symfony/python_IA/textBlobIA.py', $resena->getId()]);
        $process->setTimeout(3600);
        $io->writeln("Ejecutando proceso python con TextBlob");
